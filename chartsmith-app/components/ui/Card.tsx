...
const Card = React.forwardRef<HTMLDivElement, React.HTMLAttributes<HTMLDivElement>>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn(
      "rounded-forge-lg border shadow-lg backdrop-blur-sm",
      "bg-forge-charcoal/95",
      "border-forge-iron",
      className
    )}
    {...props}
...
const CardDescription = React.forwardRef<HTMLParagraphElement, React.HTMLAttributes<HTMLParagraphElement>>(({ className, ...props }, ref) => <p ref={ref} className={cn("text-sm text-forge-zinc", className)} {...props} />);
