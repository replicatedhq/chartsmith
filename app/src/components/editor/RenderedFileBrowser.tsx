          ...
          {[{ id: 'default', name: 'Default values.yaml', enabled: true }, ...scenarios]
            ...
            <div key={scenario.id}>
              <button
                ...
                className={`w-full px-2 py-1.5 rounded-sm text-left flex items-center gap-2 transition-colors ${
                  theme === 'dark'
                  ...
                  {nodes.map((node) => {
                    ...
                    return (
                      <button
                        ...
                        className={`w-full px-2 py-1.5 rounded-sm text-left flex items-center gap-2 transition-colors relative ${
                          selectedFile?.path === nodeWithScenario.path
                      ...
                      >
                        ...
                        {node.hasError && (
                          <div className="absolute right-2 top-1/2 -translate-y-1/2 min-w-[20px] h-5 bg-error text-white text-xs rounded-full flex items-center justify-center">
                            {node.errorCount}
                          </div>
                        )}
                      </button>
