...
func ExpandPrompt(ctx context.Context, prompt string) (string, error) {
	...
	if provider == "openrouter" {
		return ExpandPromptOpenRouter(ctx, prompt)
	}
...
// ExpandPromptOpenRouter expands a prompt using OpenRouter
func ExpandPromptOpenRouter(ctx context.Context, prompt string) (string, error) {
...
%s
	...
	expandedPrompt, err := client.ChatCompletion(ctx, messages)
	if err != nil {
